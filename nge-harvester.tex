...
more than 300,000 cores. Currently, PanDA is compatible only with few high-performance computing (HPC)
...
PanDA~\cite{PanDA} is the Workload Management System (WMS) used by the ATLAS experiment at
...
optimizations, especially related to AthenaMP~\cite{Crooks_2012} setup and the total number of
